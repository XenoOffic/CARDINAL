...
pub unsafe extern "C" fn cardinal_runtime_register_agent(
    ...
    match runtime.register_agent(agent) {
        Ok(()) => {
            CardinalResult::success(
                "agent registered"
            )
